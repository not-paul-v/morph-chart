...
describe("ChartWrapper", () => {
    ...
    it("should dispaly datapoint value, percentchange and label in header", () => {
        ...
        const percentChange =
            container.getElementsByClassName("percentChange")[0];
        ...
        expect(datapointValue.textContent).toBe(
    ...
    it("should change path on button click", () => {
        ...
        const oldPath = container
            .getElementsByTagName("path")[0]
            .getAttribute("d");
        buttons[1].click();
        const newPath = container
            .getElementsByTagName("path")[0]
            .getAttribute("d");
    ...
    it("should render chart with a custom header", () => {
        const { container } = render(
        ...
        expect(title.textContent).toBe("title - 212.08");
    });
});
